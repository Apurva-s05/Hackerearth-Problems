...
int main() {
	...
	while(T--) {
       ...
       try{
            ...
            cout << "Not enough memory" << endl;    // Check if the memory was allocated or not using bad_alloc If not, print the error message
        }
        catch(exception& e){
...
*/ In above solution,
 try{
  ...
  we have to write only this code,other part already given
  */
